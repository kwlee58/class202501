...
wrong_id <- setdiff(MH$id, class_roll$id)
MH %>%
...
# 3. MH 에서 id 틀린 행을 제거하고 옳은 id 갖춘 행으로 교체하기
MH <- MH %>%
...
dev.copy(png, file = "./pics/2402/MH_submission_13.png", width = 640, height = 480)
invisible(dev.off())
})
```
...
library(magick)
file_names <- paste0("./pics/2402/MH_submission_", 1:13, ".png")
