---
title: "Quiz 250331 (Framing Effects)"
author: "coop711"
date: "2025-03-31"
...
class_roll0321 %<>% 
  data.frame
class_roll0331 <- 
  read_excel("./data/class_roll_250331.xlsx", range = "B1:H603")
str(class_roll0331)
names(class_roll0331) <- 
  c("dept", "college", "id", "name", "status", "email", "cell_no")
class_roll0331$group <- 
  class_roll0321$group[match(class_roll0331$id, class_roll0321$id)]
saveRDS(class_roll0331, file = "./class_roll_250331.RDS")
class_roll <- class_roll0331
str(class_roll)
#> googlesheets
...
# quiz <- 
#   read_excel("./data/quiz_250331_v2.xlsx",
#              range = "A2:N560",
#              col_names = FALSE)
...
실제로 Red를 Black 이라고 한 사람수, `r wrong_tbl[1, 2]`명이나 Black 을 Red 라고 한 사람수, `r wrong_tbl[2, 1]`명은 기대인원으로부터 표준오차 범위 안에 잘 들어갑니다.
