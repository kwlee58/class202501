---
title: "Quiz 251020 (Cognitive Reponse Test)"
author: "coop711"
date : "2025-04-21"
...
quiz_url <-"https://docs.google.com/spreadsheets/d/1-_hBfPz78k9fR_oLNEyhZb76atiR9o9_GOfdtbxlKU8/edit"
# gs4_deauth()
...
as.Date(quiz$time) %>%
  table
#> 마감기한으로부터 제출시점의 기간
quiz$days <- as.numeric(difftime("2025-11-03 00:00:00", quiz$time, units = 'days'))
quiz$hours <- as.numeric(difftime("2025-11-03 00:00:00", quiz$time, units = 'hours'))
str(quiz)
```
...
m4 + geom_text(aes(x = center, y = 1.05), 
  ...
  theme(plot.title = element_text(hjust = 0.5, 
                                  size = 18, 
                                  face = "bold")) 
ggsave("./pics/Quiz251020_Q4_RnB.png", dpi = 120, width = 960, height = 840, units = "px")
```
...
m5 + geom_text(aes(x = center, y = 1.05), 
  ...
  theme(plot.title = element_text(hjust = 0.5, 
                                  size = 18, 
                                  face = "bold")) 
ggsave("./pics/Quiz251020_Q5_RnB.png", dpi = 120, width = 960, height = 840, units = "px")
```
...
m6 + geom_text(aes(x = center, y = 1.05), 
  ...
  theme(plot.title = element_text(hjust = 0.5, 
                                  size = 18, 
                                  face = "bold")) 
ggsave("./pics/Quiz251020_Q6_RnB.png", dpi = 120, width = 960, height = 840, units = "px")
```
...
title(main = paste0("Quiz251020 (", N, "명 제출)"))
# title(main = "일 단위 퀴즈 제출 인원", sub = paste0("Quiz230925 (", N, "명 제출)"))
dev.copy(png, file = "./pics/2502/quiz_submission_8.png", width = 640, height = 480)
invisible(dev.off())
})
```
...
```{r, save, echo = FALSE}
saveRDS(quiz[c("id", "name")], file = "./quiz251020.RDS")
```
