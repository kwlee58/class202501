...
literacy_wrong_ids <- 
  literacy_wrong_ids %>%
  mutate(id = case_when(
    id == "20236650" ~ "20243650",
    id == "202043236" ~ "20243236",
    id == "20243247" ~ "20243257",
    id == "20242427" ~ "20242327",
    id == "24" & name == "박준형" ~ "20244120",
    id == "20243713" ~ "20243712",
    id == "24" & name == "이수용" ~ "20243938",
    id == "202023702" ~ "20203702",
    id == "20236738" ~ "20236739",
    id == "24" & name == "김윤아" ~ "20246224",
    id == "소프트웨어학부" & dept == "20245268" ~ "20245268",
    id == "러시아학과" & dept == "20241728" ~ "20241728",
    TRUE ~ id
  ))
