...
class_roll0404 <- class_roll
class_roll <- 
  readxl::read_excel("../data/class_roll230607.xlsx",
                     range = "B1:I1004")
names(class_roll) <- 
  c("college", "dept", "year", "id", "name", "status", "email", "cell_number")
class_roll[class_roll$id == "20226644", "name"] <- "최연오"
comment <-
  readxl::read_excel("../data/data_lab_230607.xlsx",
                     range = "A2:H14442", 
                     col_names = TRUE)
# comment <-
...
## 게시 후 2주 이내 1점, 지나면 0.7점 부여 (6월 7일 09:00 기준)
...
```{r}
comments_w$group <- class_roll0404$group[match(comments_w$id, class_roll0404$id)]
