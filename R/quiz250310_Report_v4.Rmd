...
#   class_roll0310$group[match(class_roll0913$id, class_roll0310$id)]
...
#> 마감기한으로부터 제출시점의 기간
quiz$days <- 
  as.numeric(difftime("2025-03-24 09:00:00", quiz$time, units = 'days'))
quiz$hours <- 
  as.numeric(difftime("2025-03-24 09:00:00", quiz$time, units = 'hours'))
str(quiz)
pander(summary(quiz))
```
