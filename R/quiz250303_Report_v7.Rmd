...
font_add(family = "Spoqa", 
         regular = "~/Library/Fonts/SpoqaHanSansNeo-Regular.ttf",
         bold = "~/Library/Fonts/SpoqaHanSansNeo-Bold.ttf",
         italic  = "~/Library/Fonts/SpoqaHanSansNeo-Light.ttf")
showtext_auto()
