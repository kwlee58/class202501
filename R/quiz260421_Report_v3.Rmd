...
class_roll <- 
  readRDS("./class_roll_260413.RDS")
class_roll %<>% 
  data.frame
# class_roll <- 
#   read_excel("./data/class_roll_251020.xlsx", 
#              range = "B1:H599")
# class_roll %<>% 
#   data.frame
# str(class_roll)
...
# saveRDS(class_roll, file = "./class_roll_251020.RDS")
...
quiz_wrong_ids <- quiz_wrong_ids %>%
  mutate(
    id = case_when(
      id == "202233456" ~ "20223346",
      id == "202106511" ~ "20216511",
      id == "202462227" ~ "20246227",
      id == "202052326" ~ "20252326",
      TRUE ~ id
      ),
    name = case_when(
      id == "20236155" & name == "이태" ~ "이태경",
      id == "20238010" & name == "xuchenxing" ~ "xu chenxing",
      id == "20178019" & name == "Chen shuaihao" ~ "CHEN SHUAIHAO",
...
#   quiz[., c("id", "name")]
quiz %>%
  filter(id %in% c("20253208","20251105", "20252991"))
...
ggsave("./pics/Quiz251020_submission_8.png", dpi = 120, width = 960, height = 840, units = "px")
```
