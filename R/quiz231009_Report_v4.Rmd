...
quiz_url <-
  "https://docs.google.com/spreadsheets/d/1n1FYjDn02fUS1NkxWrYF08SqS-posMUdos7FpGyakug"
# gs4_deauth()
...
#> 마감기한으로부터 제출시점의 기간
quiz$days <- as.numeric(difftime("2023-10-23 00:00:00", quiz$time, units = 'days'))
quiz$hours <- as.numeric(difftime("2023-10-23 00:00:00", quiz$time, units = 'hours'))
str(quiz)
```
...
m + geom_text(aes(x = center, y = 1.05), 
  ...
  theme(plot.title = element_text(hjust = 0.5, 
                                  size = 18, 
                                  face = "bold")) 
ggsave("./pics/Quiz231009_Q9_RnB.png", dpi = 120, width = 960, height = 840, units = "px")
```
...
dev.copy(png, file = "./pics/2302/quiz_submission_7.png", width = 640, height = 480)
invisible(dev.off())
})
```
...
ggsave("./pics/Quiz231009_submission_7.png", dpi = 120, width = 960, height = 840, units = "px")
```
