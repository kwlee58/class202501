...
#> 출석부에 변화가 생기면 조치
# class_roll1012 <- 
#   read_excel("./data/class_roll_251012.xlsx", range = "B1:H608")
# str(class_roll1012)
# names(class_roll1012) <- 
#   c("dept", "college", "id", "name", "status", "email", "cell_no")
# class_roll1012$group <- 
#   class_roll1005$group[match(class_roll1012$id, class_roll1005$id)]
# saveRDS(class_roll1012, file = "./class_roll_251012.RDS")
...
#   quiz[., c("id", "name")]
quiz %>%
  filter(id %in% c("20245269", "20237016", "20215201", "20203823", "20252238"))
quiz <- quiz %>% 
