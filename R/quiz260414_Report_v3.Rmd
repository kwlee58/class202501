...
class_roll <- 
  read_excel("./data/class_roll_260427.xlsx", 
             range = "B1:H606")
class_roll %<>% 
   data.frame
str(class_roll)
...
class_roll$group <- 
  class_roll0413$group[match(class_roll$id, class_roll0413$id)]
saveRDS(class_roll, file = "./class_roll_260427.RDS")
# class_roll <- class_roll0427
#> googlesheets4 패키지 시험
quiz_url <-
  "https://https://docs.google.com/spreadsheets/d/1FWJIOgyw4auTCcxQmMt3M_beB8U4GEsUmbugkCmjQmI"
# gs4_deauth()
...
#   quiz[., c("id", "name")]
quiz %>%
  filter(id %in% c("20251114", "20217187", "20252971", "20256182", "20241035", "20243914"))
...
정답인 {A,3}를 올린 `r format(tbl_q9_a[2, 2], digits = 3, nsmall = 0)`(명)보다 적습니다.
