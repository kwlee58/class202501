...
MW <- "../data/MW220530.xlsx" %>%
  read_excel(range = "A1:O851")
str(MW)
#> Names for the Columns
names(MW) <- c("Time", "email", "Team", "id", "name", paste0("Q", 1:10)) 
MW %<>% 
  data.frame
class(MW$id) <- "character"
str(MW)
# kable(MW)
...
```{r, echo = FALSE, eval = TRUE}
#> Worst team scores
kable(result_df[result_df$"팀" %in% worst_names, ], row.names = FALSE) 
# str(quiz1128)
```
-->
<!--
...
saveRDS(result_df, file = "../R/MW220530.RDS")
save.image("./MW.RDada")
```
-->
