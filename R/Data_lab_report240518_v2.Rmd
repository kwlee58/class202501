...
options(digits = 2)
class_roll <- readRDS("./class_roll_240517.RDS")
class_roll <- data.frame(class_roll)
comment <-
  readxl::read_excel("./data/data_lab_240518.xlsx",
                     range = "A2:H7821", 
                     col_names = TRUE)
# comment <-
