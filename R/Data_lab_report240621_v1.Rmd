...
#                      col_names = TRUE)
comment <-
  read_csv("./data/data_lab_240621_v2.csv")
comment %<>%
  data.frame
...
## 게시 후 2주 이내 1점, 지나면 0.7점 부여 (6월 20일 24:00 기준)
...
write.csv(comments_w[order(comments_w$name, comments_w$id), 
          ...
          file = "./data/comments240621_w_v1.csv", 
          row.names = FALSE,
          fileEncoding = "UTF-8")
saveRDS(comments_w[order(comments_w$name, comments_w$id), 
                 c("id", "name", "group", "total")],
        file = "./data_lab240621_v1.RDS")
save.image(file = "./data_lab240621_v1.RData")
```
