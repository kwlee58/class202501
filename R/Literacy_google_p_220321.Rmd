...
load("./red_and_black_220311_data.RData")
# literacy_roll <- read.xlsx("../data/literacy_220321.xlsx", 
#                            sheetIndex = 1, 
#                            startRow = 1, 
#                            endRow  = 294, 
#                            colIndex = c(3, 6:30), 
...
#                            encoding = "UTF-8")
literacy_roll <- 
  read_excel("./data/literacy_220321.xlsx",
             range = "C1:AD844",
             col_names = TRUE)
literacy_roll <- literacy_roll[-1, -c(1, 3)]
...
kable(literacy)
saveRDS(literacy_roll, file = "./literacy_roll220321.RDS")
```
...
#> x축의 라벨을 막대에 보다 가깝게 조정 (flip해서 x축을 수직으로 세울 예정이므로 y = -30)
  geom_text(mapping = aes(y = -30, label = Questions)) +
