...
comment <-
  readxl::read_excel("./data/data_lab_231217.xlsx",
                     range = "A2:H17758", 
                     col_names = TRUE)
# comment <-
...
## 게시 후 2주 이내 1점, 지나면 0.7점 부여 (12월 18일 00:04 기준)
