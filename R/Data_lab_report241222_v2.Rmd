...
comment <-
  read_excel("./data/data_lab_241222.xlsx",
             range = "A2:H15775", 
             col_names = TRUE)
str(comment)
#> csv 인 경우
...
## 게시 후 2주 이내 1점, 지나면 0.7점 부여 (12월 22일 24:00 기준)
