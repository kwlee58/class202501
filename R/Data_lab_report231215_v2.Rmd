...
comment <-
  readxl::read_excel("./data/data_lab_231215.xlsx",
                     range = "A2:H16204", 
                     col_names = TRUE)
# comment <-
...
## 게시 후 2주 이내 1점, 지나면 0.7점 부여 (12월 15일 19:00 기준)
