...
## 수강 철회 반영 새 출석부
# class_roll1005 <- read_excel("./data/class_roll_251005.xlsx", 
#                         range = "B1:H608")
# names(class_roll1005) <- c("dept", "college", "id", "name", "status", "email", "cell_no")
# str(class_roll1005)
# class_roll1005$group <- 
#   class_roll0928$group[match(class_roll1005$id, class_roll0928$id)]
# class_roll_250928 저장
# saveRDS(class_roll1005, file = "./class_roll_251005.RDS")
