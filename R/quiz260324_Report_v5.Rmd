...
quiz_wrong_ids <- quiz_wrong_ids %>%
  mutate(
    id = case_when(
      ...
      id == "202221625" ~ "20221625",
      id == "20040322" ~ "20243322",
...
"찬성한다"고 응답한 백분율은 Red, Black 합쳐서  `r format(ptbl_q7[1], digits = 2, nsmall = 1)`(%)(으)로  '반대한다"고 응답한 백분율, `r format(ptbl_q7[2], digits = 2, nsmall = 1)`(%) 과 약간 적습니다. 
...
title(main = paste0("Quiz250922 (", N, "명 제출)"))
