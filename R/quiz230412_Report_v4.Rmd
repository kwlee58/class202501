---
title: "Quiz 230412 (Wason Selection Task)"
author: "coop711"
date: "2023-04-12"
...
quiz_url <-
  "https://docs.google.com/spreadsheets/d/1litRZF81KukDXfY0FL9fJYTFo4XfY4vdtYfD9rc0W5U"
# gs4_deauth()
...
#> 마감기한으로부터 제출시점의 기간
quiz$days <- as.numeric(difftime("2023-04-26 00:00:00", quiz$time, units = 'days'))
quiz$hours <- as.numeric(difftime("2023-04-26 00:00:00", quiz$time, units = 'hours'))
str(quiz)
```
...
m + geom_text(aes(x = center, y = 1.05), 
  ...
  theme(plot.title = element_text(hjust = 0.5, 
                                  size = 18, 
                                  face = "bold")) 
ggsave("./pics/Quiz230412_Q7_RnB.png", dpi = 120, width = 960, height = 840, units = "px")
```
...
m + geom_text(aes(x = center, y = 1.05), 
  ...
  theme(plot.title = element_text(hjust = 0.5, 
                                  size = 18, 
                                  face = "bold")) 
ggsave("./pics/Quiz230412_Q8_RnB.png", dpi = 120, width = 960, height = 840, units = "px")
```
...
m + geom_text(aes(x = center, y = 1.05), 
  ...
  theme(plot.title = element_text(hjust = 0.5, 
                                  size = 18, 
                                  face = "bold")) 
ggsave("./pics/Quiz230412_Q9_RnB.png", dpi = 120, width = 960, height = 840, units = "px")
```
...
m + 
  ...
  theme(plot.title = element_text(hjust = 0.5, 
                                  size = 18, 
                                  face = "bold")) 
ggsave("./pics/Quiz230412_Wason_RnB.png", dpi = 120, width = 960, height = 840, units = "px")
```
...
b_fill + 
  ...
  theme(plot.title = element_text(hjust = 0.5, 
                                  size = 18, 
                                  face = "bold")) 
ggsave("./pics/Quiz230412_Wason_Result.png", dpi = 120, width = 960, height = 840, units = "px")
```
...
title(main = paste0("Quiz230412 (", N, "명 제출)"))
# title(main = "일 단위 퀴즈 제출 인원", sub = paste0("Quiz230925 (", N, "명 제출)"))
dev.copy(png, file = "./pics/2301/quiz_submission_7.png", width = 640, height = 480)
invisible(dev.off())
})
```
...
ggsave("./pics/Quiz230412_submission_7.png", dpi = 120, width = 960, height = 840, units = "px")
```

```{r, save, echo = FALSE}
saveRDS(quiz, file = "quiz230412.RDS")
```
