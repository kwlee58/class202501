...
kable(comments_w[order(comments_w$id, comments_w$name), 
      ...
      digits = 4,
      row.names = FALSE,
      col.names = c("학번", paste0(1:N_labs, "회차"), "총점"))
```

# 회차별 점수 

```{r, echo = FALSE}
kable(comments[order(comments$id), -2], 
      row.names = FALSE,
      col.names = c("학번", "회차", "게시시점", "댓글시점", "경과시간(주)", "점수"))
```
