...
literacy_roll <- 
  read_excel("./data/literacy_230925.xlsx",
             range = "C1:AD857",
             col_names = TRUE)
...
absentee$group %>%
  table
#> RDS 포맷으로 저장 
saveRDS(literacy_roll, file = "./literacy_roll230925.RDS")
```
...
# png(file = "./pics/Literacy_230925.png", width = 640, height = 840)
...
# dev.copy(png, file = "./pics/Literacy_230925.png", width = 640, height = 840)
invisible(dev.off())
```
...
#  coord_flip()
ggsave(file = "./pics/Literacy_230925_ggplot.png", bg = "white", dpi = 72, width = 840, height = 480, units = "px")
```
