...
quiz <- 
  read_excel("../data/quiz230315.xlsx",
             range = "A2:N915",
             col_names = FALSE)
...
quiz$days <- as.numeric(difftime("2023-03-29 09:00:00", quiz$time, units = 'days'))
quiz$hours <- as.numeric(difftime("2023-03-29 09:00:00", quiz$time, units = 'hours'))
str(quiz)
```
...
ggsave("../pics/Quiz230315_Q7_RnB.png", dpi = 120, width = 960, height = 840, units = "px")
```
...
title(main = paste0("Quiz230315 (", N, "명 제출)"))
# title(main = "일 단위 퀴즈 제출 인원", sub = paste0("Quiz230315 (", N, "명 제출)"))
dev.copy(png, file = "../pics/2301/quiz_submission_3.png", width = 640, height = 480)
invisible(dev.off())
```

```{r, save, echo = FALSE}
saveRDS(quiz, file = "./quiz230315.RDS")
save.image("../R/quiz230315.RData")
```