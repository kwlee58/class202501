---
title: "Quiz 251117 (Framing Effects)"
author: "coop711"
# date : "2025-11-17"
...
quiz_url <-"https://docs.google.com/spreadsheets/d/1C-Z_GVZ6kKccSsFswA6jXg2COkGJcuPJ0wNw7gLJaZs"
# gs4_deauth()
quiz <- read_sheet(quiz_url)
# quiz <- 
#   read_excel("./data/quiz251117.xlsx",
#              range = "A1:Y701")
names(quiz) <- 
...
#> 마감기한으로부터 제출시점의 기간
quiz$days <- 
  as.numeric(difftime("2025-12-01 00:00:00", 
...
title(main = paste0("Quiz251117 (", N, "명 제출)"))
# title(main = "일 단위 퀴즈 제출 인원", sub = paste0("Quiz230925 (", N, "명 제출)"))
dev.copy(png, file = "./pics/2502/quiz_submission_12.png", width = 640, height = 480)
invisible(dev.off())
})
```
...
ggsave("./pics/Quiz251117_submission_12.png", dpi = 120, width = 960, height = 840, units = "px")
```

```{r, save, echo = FALSE}
saveRDS(quiz, file = "quiz251117.RDS")
```
