...
comment <-
  readxl::read_excel("./data/data_lab_240402.xlsx",
                     range = "A2:H2597", 
                     col_names = TRUE)
# comment <-
...
## 게시 후 2주 이내 1점, 지나면 0.7점 부여 (4월 2일 12:30 기준)
