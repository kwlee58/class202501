---
title: "Quiz 251110 (Anchor Effects)"
author: "coop711"
date : "2025-11-10"
...
#> 
quiz_url <-"https://docs.google.com/spreadsheets/d/1t6Je9lOLWxMKs40TlA2coEMl-XCo2QEV66GeqFg6B6k"
# gs4_deauth()
...
as.Date(quiz$time) %>%
  table
#> 마감기한으로부터 제출시점의 기간
quiz$days <- as.numeric(difftime("2025-11-24 00:00:00", quiz$time, 
                                 tz = "Asia/Seoul",  units = 'days'))
quiz$hours <- as.numeric(difftime("2025-11-24 00:00:00", quiz$time, 
...
title(main = paste0("Quiz251110 (", N, "명 제출)"))
# title(main = "일 단위 퀴즈 제출 인원", sub = paste0("Quiz230925 (", N, "명 제출)"))
dev.copy(png, file = "./pics/2502/quiz_submission_11.png", width = 640, height = 480)
invisible(dev.off())
})
```
...
ggsave("./pics/Quiz251110_submission_11.png", dpi = 120, width = 960, height = 840, units = "px")
```

```{r, save, echo = FALSE}
saveRDS(quiz, file = "quiz251110.RDS")
```