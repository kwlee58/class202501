...
comment <-
  readxl::read_excel("./data/data_lab_240930.xlsx",
                     range = "A2:H2398", 
                     col_names = TRUE)
# comment <-
...
## 게시 후 2주 이내 1점, 지나면 0.7점 부여 (9월 30일 09:00 기준)
