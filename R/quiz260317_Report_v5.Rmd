...
감세정책의 긍정적 측면을 설명한 Red에서 우리나라의 국민부담률을 "낮춰야 한다"고 응답하는사람들의 백분율, `r format(ptbl_q7_a[1, 1], digits = 2, nsmall = 1)`(%)은 "높여야 한다"고 응답하는 사람들의 백분율, `r format(ptbl_q7_a[1, 2], digits = 2, nsmall = 1)`(%) 보다 조금 적습니다.
...
title(main = paste0("Quiz250915 (", N, "명 제출)"))
