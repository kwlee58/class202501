...
title(main = "소득세 최고세율 국제 비교", line = 2, cex.main = 2.0, family = "NanumGothic")
...
title(main = "소득세 부담 국제 비교", line = 2, cex.main = 2.0, family = "NanumGothic")
...
text(x = year_c[11], y = c(as.numeric(corporate_df[11, -1])), 
     ...
     pos = c(4, 4, 4, 4, 4, 4, 4, 4, 1, 4))
title(main = "법인세 최고세율 국제 비교", line = 2, cex.main = 2.0, family = "NanumGothic")
...
title(main = "법인세 부담 국제 비교", line = 2, cex.main = 2.0, family = "NanumGothic")
...
text(x = year_v[10], y = c(as.numeric(vat_df[10, -1])), 
     ...
     pos = c(4, 4, 4, 4, 4, 4, 4, 4, 4, 4))
title(main = "부가가치세율 국제 비교", line = 2, cex.main = 2.0, family = "NanumGothic")
...
text(x = year_vb[5], y = c(as.numeric(vat_b_df[5, -1])), 
     ...
     pos = c(4, 4, 4, 4, 4, 4, 4))
title(main = "부가가치세 부담 국제 비교", line = 2, cex.main = 2.0, family = "NanumGothic")
