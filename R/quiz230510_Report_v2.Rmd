---
title: "Quiz 230510 (Anchor Effects)"
author: "coop711"
date: "2023-05-10"
...
quiz <- 
  read_excel("../data/quiz230510.xlsx",
             range = "A2:N838",
             col_names = FALSE)
str(quiz)
...
quiz$days <- as.numeric(difftime("2023-05-24 09:00:00", quiz$time, units = 'days'))
quiz$hours <- as.numeric(difftime("2023-05-24 09:00:00", quiz$time, units = 'hours'))
quiz %>% 
  str
```
...
title(main = paste0("Quiz230510 (", N, "명 제출)"))
# title(main = "일 단위 퀴즈 제출 인원", sub = paste0("Quiz230510 (", N, "명 제출)"))
dev.copy(png, file = "../pics/2301/quiz_submission_11.png", width = 640, height = 480)
invisible(dev.off())
```

```{r, save, echo = FALSE}
saveRDS(quiz, file = "quiz230510.RDS")
save.image("../R/quiz230510.RData")
```