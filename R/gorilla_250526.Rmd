---
title: "Invisible Gorilla 202501"
author: "coop711"
# date: "2025-05-26"
...
gorilla_url <- "https://docs.google.com/spreadsheets/d/1YmoTyLYsf_4ZVTNPuhQoo4EIFaTbNAsL0IyOWArgFlc"
...
gorilla_wrong_ids <- gorilla_wrong_ids %>%
  mutate(id = case_when(
    ...
    id == "2242432" ~ "20242432",
    id == "2024414" ~ "20244144",
    id == "20242687" ~ "20242587",
    id == "2019405" ~ "20196405",
    id == "사회학과" & name == "박시현" ~ "20212214",
    TRUE ~ id
    ),
    name = case_when(
      name == "초원" ~ "윤초원",
...
saveRDS(gorilla, file = "gorilla_250526.RDS")
```
-->