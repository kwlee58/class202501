...
quiz_wrong_ids <- quiz_wrong_ids %>%
  mutate(
    id = case_when(
      ...
      id == "융합과학수사학과" & name == "박한성" ~ "20216409",
      id == "20246725" ~ "20246275",
    TRUE ~ id
    ),
    name = case_when(
...
M19_2 <- c(62, 84)
MPG <- 
  cbind(M19_2, M20_1, M20_2, M21_1, M21_2, M22_1, M22_2, M23_1, M23_2, M24_1, M24_2, M25_1)
semesters <- 
  c("19/2", "", "20/2", "21/1", "21/2", "22/1", "22/2", "23/1", "23/2", "24/1", "24/2", "25/1")
