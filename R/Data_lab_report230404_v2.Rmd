...
comment <-
  readxl::read_excel("../data/data_lab_230404_v2.xlsx",
                     range = "A2:H3497", 
                     col_names = TRUE)
# comment <-
...
## 게시 후 2주 이내 1점, 지나면 0.7점 부여 (11월 1일 15:58 기준)
