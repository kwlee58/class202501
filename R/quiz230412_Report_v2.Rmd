...
quiz <- 
  read_excel("./data/quiz230412.xlsx",
             range = "A2:P855",
             col_names = FALSE)
...
quiz$days <- as.numeric(difftime("2023-04-26 09:00:00", quiz$time, units = 'days'))
...
# title(main = "일 단위 퀴즈 제출 인원", sub = paste0("Quiz230412 (", N, "명 제출)"))
