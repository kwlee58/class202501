...
class_roll <- class_roll0921
#> quiz reading
sheet_url <- "https://docs.google.com/spreadsheets/d/1r3xiEqfW9X0NmQyK7cabPSC1lRa6HpsFu4TBTy5IuLA"
quiz <- read_sheet(sheet_url)
# quiz <- 
#   read_excel("./data/quiz_250908.xlsx",
#              range = "A2:N565",
#              col_names = FALSE)
names(quiz) <- 
...
#> 마감기한으로부터 제출시점의 기간
quiz$days <- 
  as.numeric(difftime("2025-09-22 00:00:00", quiz$time, units = 'days'))
quiz$hours <- 
  as.numeric(difftime("2025-09-22 00:00:00", quiz$time, units = 'hours'))
...
m + geom_text(aes(x = center, y = 1.05), 
  ...
  theme(plot.title = element_text(hjust = 0.5, 
                                  size = 18, 
                                  face = "bold")) 
ggsave("./pics/Quiz250908_Q7_RnB.png", dpi = 120, width = 960, height = 840, units = "px")
```
...
title(main = paste0("Quiz250908 (", N, "명 제출)"))
# title(main = "일 단위 퀴즈 제출 인원", sub = paste0("Quiz230925 (", N, "명 제출)"))
dev.copy(png, file = "./pics/2502/quiz_submission_2.png", width = 640, height = 480)
invisible(dev.off())
})
```
...
ggsave("./pics/Quiz250908_submission_2.png", dpi = 120, width = 960, height = 840, units = "px")
```

```{r, save, echo = FALSE}
saveRDS(quiz, file = "./quiz250908.RDS")
```