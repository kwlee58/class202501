...
probs <- 
  sapply(2:100, FUN = function(x) birthday(N = 1000000, x))
opar <- par(no.readonly = TRUE)
par(mai = c(1.02, 1.02, 0.82, 0.42))
plot(2:100, probs, type = "p", pch = 20, cex = 1, axes = FALSE, xlab = "Number of People", ylab = "")
...
arrows(x0 = 23, y0 = 0, x1 = 23, y1 = probs[22], code = 1, length = 0.15, lwd = 3)
arrows(x0 = 0, y0 = probs[22], x1 = 23, y1 = probs[22], code = 1, length = 0.15, lwd = 3)
title(ylab = "Probability", line = 4)
title(main = "Birthday Problem")
dev.copy(png, file = "../pics/birthday_simulation.png", width = 768, height = 576)
dev.off()
```
