...
```{r, echo = FALSE}
load("./BFI_MI_report_221107.RData")
```
-->
...
ggsave("./pics/BFP_221107.png", dpi = 120, width = 10, height = 7.5, units = "in")
```
...
m_fill + 
  ...
  theme(plot.title = element_text(hjust = 0.5, 
                                  size = 18, 
                                  family = "KoPubWorldDotum Bold"))
ggsave("./pics/MI_221107.png", dpi = 120, width = 10, height = 7.5, units = "in")
```
