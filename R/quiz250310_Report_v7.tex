...
그 결과 카이제곱 통계량은 9.06, 자유도는 NA , p-value 는 0.0515이므로
...
그 결과 카이제곱 통계량은 2.056, 자유도는 NA, p-value 는 0.6722이므로
Red, Black 간에 통계적으로 유의한 차이를 보이지 않습니다.
...
그 결과 카이제곱 통계량은 8.269, 자유도는 NA, p-value 는 0.0435이므로
...
그 결과 카이제곱 통계량은 0.795, 자유도는 NA, p-value 는 0.8611이므로
Red, Black 간에 통계적으로 유의한 차이를 보이지 않습니다.
