...
사후 장기기증 의사가 있다고 응답한 백분률은 default의 설정과는 무관하게 `r format(ptbl_q7[1], digits = 2, nsmall = 1)`(%)(으)로 절반이 좀 넘습니다. 
