...
# load("./red_and_black_optimum_data_202301_id_college.RData")
class_roll <- read_excel("./data/class_roll240226.xlsx", 
                        range = "B1:I912")
str(class_roll)
...
```{r, echo = FALSE}
hist(Xsum, prob = TRUE, nclass = 30, xlim = c(0, 50), ylim = c(0, 0.08))
x <- seq(0, 50, by = 0.1)
...
<!--
```{r, save}
save.image("./red_and_black_optimum_data_240226_id_college_1000000.RData")
```
-->