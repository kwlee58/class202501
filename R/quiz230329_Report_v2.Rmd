...
quiz <- 
  read_excel("../data/quiz230329.xlsx",
             range = "A2:N899",
             col_names = FALSE)
...
#> 제출시간 분포 분석 코드 
quiz$days <- as.numeric(difftime("2023-04-12 09:00:00", quiz$time, units = 'days'))
quiz$hours <- as.numeric(difftime("2023-04-12 09:00:00", quiz$time, units = 'hours'))
str(quiz)
```
...
ggsave("../pics/Quiz230329_Q7_RnB.png", dpi = 120, width = 960, height = 840, units = "px")
```
...
title(main = paste0("Quiz230329 (", N, "명 제출)"))
# title(main = "일 단위 퀴즈 제출 인원", sub = paste0("Quiz230329 (", N, "명 제출)"))
dev.copy(png, file = "../pics/2301/quiz_submission_5.png", width = 640, height = 480)
invisible(dev.off())
```

```{r, save, echo = FALSE}
saveRDS(quiz, file = "./quiz230329.RDS")
save.image("../R/quiz230329.RData")
```