---
title: "Quiz 250929 (Framing Effects)"
author: "coop711"
date: "2025-09-29"
...
class_roll <- class_roll1012
str(class_roll)
#> googlesheets
sheet_url <- "https://docs.google.com/spreadsheets/d/1sfNPMOadcjPtdCntAX-35cq582VJxByYhP1KWz87f84"
quiz <- 
...
quiz <- data.frame(quiz)
#> 마감기한으로부터 제출시점의 기간
quiz$days <- as.numeric(difftime("2025-10-13 00:00:00", quiz$time, units = 'days'))
quiz$hours <- as.numeric(difftime("2025-10-13 00:00:00", quiz$time, units = 'hours'))
str(quiz)
```
...
title(main = paste0("Quiz250929 (", N, "명 제출)"))
# title(main = "일 단위 퀴즈 제출 인원", sub = paste0("Quiz230925 (", N, "명 제출)"))
dev.copy(png, file = "./pics/2502/quiz_submission_5.png", width = 640, height = 480)
invisible(dev.off())
})
```
...
ggsave("./pics/Quiz250929_submission_5.png", dpi = 120, width = 960, height = 840, units = "px")
```

```{r, save, echo = FALSE}
saveRDS(quiz, file = "./quiz250929.RDS")
```