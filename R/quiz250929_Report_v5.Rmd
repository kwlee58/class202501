...
class_roll0921 <- readRDS("./class_roll_250921.RDS")
class_roll0921 %<>% 
  data.frame
#> 출석부에 변화가 생기면 조치
# class_roll0929 <- 
#   read_excel("./data/class_roll_250929.xlsx", range = "B1:H603")
# str(class_roll0929)
# names(class_roll0929) <- 
#   c("dept", "college", "id", "name", "status", "email", "cell_no")
# class_roll0929$group <- 
#   class_roll0921$group[match(class_roll0929$id, class_roll0921$id)]
# saveRDS(class_roll0929, file = "./class_roll_250929.RDS")
