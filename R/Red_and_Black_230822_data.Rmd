...
```{r, data}
class_roll <- read_excel("../data/class_roll230822.xlsx", 
                        range = "B1:I909")
str(class_roll)
...
<!--
```{r, save}
saveRDS(class_roll, file = "./class_roll0822.RDS")
save.image("./red_and_black_230822_data.RData")
```
-->