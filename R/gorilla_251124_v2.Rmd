---
title: "Invisible Gorilla 202502"
author: "coop711"
# date: "2025-11-24"
...
```{r, echo = FALSE, message = FALSE, results='hide'}
class_roll <- readRDS("./class_roll_251026.RDS")
...
gorilla_wrong_ids <- gorilla_wrong_ids %>%
  mutate(
    id = case_when(
      id == "20212167" ~ "20212617",
      id == "20246205" ~ "20246295",
      id == "20256923" ~ "20246923",
      id == "20246794" ~ "20246719",
      id == "202529883" ~ "20252983",
      id == "소프트웨어학과" & name == "박일경" ~ "20255170",
      TRUE ~ id
    ),
    name = case_when(
      id == "20256726" & name == "박 윤" ~ "박윤",
      id == "20203332" & name == "양주" ~ "양주석",
...
saveRDS(gorilla, file = "gorilla_2501124.RDS")
```
-->