...
comment <-
  read_excel("./data/data_lab_241208.xlsx",
             range = "A2:H11934", 
             col_names = TRUE)
str(comment)
#> csv 인 경우
...
comment[comment$title == "03. Quiz 240301 집계결과 분석 (부연설명의 효과, 집계 중이므로 열람 O, 댓글 X)", "title"] <-
  "03. Quiz 240902 집계결과 분석 (부연설명의 효과)"
...
## 게시 후 2주 이내 1점, 지나면 0.7점 부여 (12월 08일 21:10 기준)
