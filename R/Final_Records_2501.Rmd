...
total <-
  read_excel(path = "./data/Final_Records_2501_0616.xlsx",
             range = "A1:L597",
...
FA_id <- c("20182101", "20202327", "20205160", "20213302", "20215152", "20215266",
           "20221507", "20223517", "20224103", "20226409", "20226424", "20227056",
           "20232941", "20241042", "20241090", "20241216", "20242508", "20242969",
           "20242999", "20243029", "20243403", "20243708", "20243831", "20243841", 
           "20246627", "20246703", "20246923", "20252916", "20253244", "20253840")
...
Counts_tbl <- total$Total %>% 
  cut(breaks = c(0, 20, 40, 60, 70, 87, 90, 94, 95, 100),
      labels = c("[0 ~ 20)", 
                 "[20 ~ 40)",
                 "[40 ~ 60)",
                 "[60 ~ 70)", 
...
v_names_kr <- c("학번", "이름", "온라인출석", "온라인퀴즈", "TED 퀴즈", "구글설문지 참여", "데이터실험", "총점", "등급")
total_kr <- total 
...
my_grade_print("20246942") %>%
  data.frame(Grade_Report = .) %>%
  kable
#> x at the top remove
sapply(c("20246942", "20246940"), 
       FUN = my_grade_print) %>%
