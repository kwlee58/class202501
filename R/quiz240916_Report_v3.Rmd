...
랜덤화출석부에 있는 Red, Black 과 실제 구글예습퀴즈에 올린 Red, Black 이 여전히 다른 사람들이 있어서 파악해 보았습니다. Red를 Black 이라고 한 사람의 수효(3명)과 Black을 Red 라고 한 사람의 수효(3명)이 매우 닮았습니다. 요약의 일관성을 기하기 위하여 기대값과 표준오차를 계산해 봅니다. 21명을 랜덤하게 둘로 나누면 $21/2\pm\sqrt21/2$명 = 11.5 $\pm$ 2.3명 이 나오는데 굳이 이 계산을 하지 않아도 더 이상 닮을 방법이 없다는 것을 쉽게 알 수 있습니다.
