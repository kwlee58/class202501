---
title: "Quiz 260407 (The more, the better?)"
author: "coop711"
# date: "2026-04-07"
...
class_roll0406 <- readRDS("./class_roll_260406.RDS")
class_roll0406 %<>% 
  data.frame
# class_roll0407 <- 
...
str(class_roll)
sheet_url <- "https://docs.google.com/spreadsheets/d/1Bb8lNY7cRYItbJLPxR2QggblwWF3B7HkNLS9Ocp-BxI"
quiz <- 
...
#> 제출시간 분포 분석 코드 
quiz$days <- as.numeric(difftime("2026-04-21 00:00:00", quiz$time, units = 'days'))
quiz$hours <- as.numeric(difftime("2026-04-21 00:00:00", quiz$time, units = 'hours'))
str(quiz)
```
...
W16_2 <- c(63, 28)
W16_1 <- c(44, 19)
WW <- cbind(W16_1, W16_2, W17_1, W17_2, W18_2, W19_1, W19_2, W20_1, W20_2, W21_1, W21_2, W22_1, W22_2, W23_1, W23_2, W24_1, W24_2, W25_1, W25_2, W26_1)
semesters <- c("16/1", "16/2", "17/1", "17/2", "18/2", "19/1", "19/2", "20/1", "20/2", "21/1", "21/2", "22/1", "22/2", "23/1", "23/2", "24/1", "24/2", "25/1", "25/2", "26_1")
...
custom_labels <-
  c("16/1", "", "", "17/2", "", "", "19/2", "", "20/2", "21/1", "21/2", "22/1", "22/2", "23/1", "23/2", "24/1", "24/2", "25/1", "25/2", "26_1")
m_list$m +
...
title(main = paste0("Quiz260407 (", N, "명 제출)"))
# title(main = "일 단위 퀴즈 제출 인원", sub = paste0("Quiz230925 (", N, "명 제출)"))
dev.copy(png, file = "./pics/2601/quiz_submission_6.png", width = 640, height = 480)
invisible(dev.off())
})
```
...
ggsave("./pics/Quiz260407_submission_6.png", dpi = 120, width = 960, height = 840, units = "px")
```

```{r, save, echo = FALSE}
saveRDS(quiz, file = "./quiz260407.RDS")
```
