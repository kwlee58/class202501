...
과제 제출이 제출 기간 마지막 날에 몰린다는 것을 시각적으로 보여주고 싶어서 하나 추가하였습니다. 8주차에 접어들어가는 시점에서 마지막 날에 몰리는 현상이 뚜렷해지고 있습니다. 지금까지 랜덤화 효과를 관찰할 수 있었는데 이번에는 p-value 가 0.05보다 작습니다. 어떤 의미일까요? 제출시간과 관련한 두 가지 현상에 대해서도 여러분의 생각을 들어보고 싶습니다. 첫째, 랜덤화 효과. 둘쨰, 마감날에 몰리는 현상.
