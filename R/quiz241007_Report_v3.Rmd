...
class_roll <- readRDS("./class_roll_241004.RDS")
class_roll %<>% 
  data.frame
# class_roll <- 
#   read_excel("./data/class_roll241007.xlsx", 
#              range = "B1:I769")
# class_roll %<>% 
#   data.frame
# str(class_roll)
...
# saveRDS(class_roll, file = "./class_roll_241007.RDS")
quiz <- 
...
ggsave("./pics/Quiz241007_submission_5.png", dpi = 120, width = 960, height = 840, units = "px")
```


```{r, save, echo = FALSE}
saveRDS(class_roll, file = "./class_roll241007.RDS")
