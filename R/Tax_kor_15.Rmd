...
```{r, tax 3, echo = FALSE}
kable(data.frame("연도" = year.15, tax.2.15[, c(2, 7, 13:14)]))
```

```{r, tax 3 plot, echo = FALSE, fig.width = 12, fig.height = 9}
par(family = "KoPubWorldDotum Medium")
plot(year.15, tax.2.15[, 2], type = "b", ylim = c(0, 200), ann = FALSE)
lines(year.15, tax.2.15[, 7], type = "b", col = rainbow(10)[8])
lines(year.15, tax.2.15[, 13], type = "b", col = rainbow(10)[1])
lines(year.15, tax.2.15[, 14], type = "b", col = rainbow(10)[2])
title(main = "내국세", xlab = "연도", ylab = "납부액(조원)", cex.main = 2)
text(x = 1994, y = tax.2.15[1, c(14, 13, 7, 2)] + c(5, -5, 5, 5), labels = tax.2.15[1, c(14, 13, 7, 2)])
text(x = 2014, y = tax.2.15[21, c(14, 13, 7, 2)] + c(5, -5, 5, 5), labels = format(tax.2.15[21, c(14, 13, 7, 2)], nsmall = 1))
text(x = 2015, y = tax.2.15[22, c(14, 13, 7, 2)] + c(5, -5, 5, 5), labels = format(tax.2.15[22, c(14, 13, 7, 2)], nsmall = 1))
text(x = 2004, y = tax.2.15[11, c(14, 13, 7, 2)] + c(5, -5, 5, 5), labels = c("과년도수입", "간접세", "직접세", "내국세"))
...
```{r, tax 4, echo = FALSE}
kable(data.frame("연도" = year.15, tax.2.15[, c(7, 3:6)]))
```

```{r, tax 4 plot, echo = FALSE, fig.width = 12, fig.height = 9}
par(family = "KoPubWorldDotum Medium")
plot(year.15, tax.2.15[, 7], type = "b", ylim = c(0, 120), ann = FALSE)
lines(year.15, tax.2.15[, 3], type = "b", col = rainbow(10)[8])
lines(year.15, tax.2.15[, 4], type = "b", col = rainbow(10)[1])
lines(year.15, tax.2.15[, 5], type = "b", col = rainbow(10)[2])
lines(year.15, tax.2.15[, 6], type = "b", col = rainbow(10)[7])
title(main = "직접세", xlab = "연도", ylab = "납부액(조원)", cex.main = 2)
text(x = 1994, y = tax.2.15[1, c(6, 4, 3, 7)]+ c(-3, -3, 3, 3), labels = tax.2.15[1, c(6, 4, 3, 7)])
text(x = 2014, y = tax.2.15[21, c(6, 4, 3, 7)] + c(3, -3, 3, 3), labels = tax.2.15[21, c(6, 4, 3, 7)])
text(x = 2015, y = tax.2.15[22, c(6, 4, 3, 7)] + c(3, -3, 3, 3), labels = format(tax.2.15[22, c(6, 4, 3, 7)], nsmall = 1))
text(x = 2004, y = tax.2.15[11, c(6, 4, 3, 7)] + c(5, -5, 5, 5), labels = c("증여세 등", "소득세", "법인세", "직접세"))
dev.copy(png, file ="../pics/direct_tax_15.png", width = 960, height = 720)
```
...
```{r, tax 5, echo = FALSE}
kable(data.frame("연도" = year.15, tax.2.15[, c(13, 8:12)]))
```

```{r, tax 5 plot, echo = FALSE, fig.width = 12, fig.height = 9}
par(family = "KoPubWorldDotum Medium")
plot(year.15, tax.2.15[, 13], type = "b", ylim = c(0, 80), ann = FALSE)
lines(year.15, tax.2.15[, 8], type = "b", col = rainbow(10)[8])
lines(year.15, tax.2.15[, 9], type = "b", col = rainbow(10)[1])
lines(year.15, tax.2.15[, 10], type = "b", col = rainbow(10)[2])
lines(year.15, tax.2.15[, 11], type = "b", col = rainbow(10)[6])
lines(year.15, tax.2.15[, 12], type = "b", col = rainbow(10)[8])
title(main = "간접세", xlab = "연도", ylab = "납부액(조원)", cex.main = 2)
text(x = 1994, y = tax.2.15[1, c(9, 8, 13)]+ c(2, -2, 2), labels = tax.2.15[1, c(9, 8, 13)])
text(x = 2014, y = tax.2.15[21, c(9, 8, 13)] + c(2, -2, 2), labels = tax.2.15[21, c(9, 8, 13)])
text(x = 2015, y = tax.2.15[22, c(9, 8, 13)] + c(2, -2, 2), labels = format(tax.2.15[22, c(9, 8, 13)], nsmall = 1))
text(x = 2004, y = tax.2.15[11, c(9, 8, 13)] + c(3, -3, 3), labels = c("특별소비세 등", "부가가치세", "간접세"))
...
text(x = 1994, y = county_tax[1, c(2, 7)] + c(0.8, 0.8), labels = format(county_tax[1, c(2, 7)], nsmall = 1))
...
text(x = 2013, y = province_tax[20, c(5, 6, 4, 3, 7, 2)] + c(-0.6, 0.6, 0.6, 0.6, 0.6, 0.6), labels = format(province_tax[20, c(5, 6, 4, 3, 7, 2)], nsmall = 1))
