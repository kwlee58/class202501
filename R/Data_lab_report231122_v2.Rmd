...
comment <-
  readxl::read_excel("./data/data_lab_231122.xlsx",
                     range = "A2:H10659", 
                     col_names = TRUE)
# comment <-
...
## 게시 후 2주 이내 1점, 지나면 0.7점 부여 (11월 22일 10:00 기준)
