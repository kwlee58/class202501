---
title: "Quiz 251027 (Default Effects)"
author: "coop711"
date : "2025-10-27"
...
quiz_url <-"https://docs.google.com/spreadsheets/d/1Y_I42jhCO1zHZ3XgIff2KNiORdEkaLaAqK2HwRUE7TY"
# gs4_deauth()
...
quiz <- data.frame(quiz)
#> 마감기한으로부터 제출시점의 기간
quiz$days <- as.numeric(difftime("2025-11-10 00:00:00", quiz$time, tz = "Asia/Seoul",  units = 'days'))
quiz$hours <- as.numeric(difftime("2025-11-10 00:00:00", quiz$time, tz = "Asia/Seoul", units = 'hours'))
quiz %>% 
  str  
```
...
m + geom_text(aes(x = center, y = 1.05), 
  ...
  theme(plot.title = element_text(hjust = 0.5, 
                                  size = 18, 
                                  face = "bold")) 
ggsave("./pics/Quiz251027_Q7_RnB.png", dpi = 120, width = 960, height = 840, units = "px")
```
...
title(main = paste0("Quiz251027 (", N, "명 제출)"))
# title(main = "일 단위 퀴즈 제출 인원", sub = paste0("Quiz230925 (", N, "명 제출)"))
dev.copy(png, file = "./pics/2501/quiz_submission_9.png", width = 640, height = 480)
invisible(dev.off())
})
```
...
ggsave("./pics/Quiz251027_submission_9.png", dpi = 120, width = 960, height = 840, units = "px")
```

```{r, save, echo = FALSE}
saveRDS(quiz, file = "quiz251027.RDS")
```
