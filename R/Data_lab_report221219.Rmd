...
class_roll0909 <- class_roll
class_roll <- 
  readxl::read_excel("../data/class_roll221201.xlsx",
                     range = "B1:G1061")
# class_roll <- 
#   readxl::read_excel("../data/class_roll220909.xlsx",
#                      range = "B1:G1082")
names(class_roll) <- 
  c("dept", "id", "name", "status", "email", "cell_number")
#> 학기 중에 개명한 친구의 이름 수정.
# class_roll[class_roll$id == "20207100", "name"] <- "최지안"
comment <-
  readxl::read_excel("../data/data_lab_221219.xlsx",
                     range = "A2:H21406", 
                     col_names = TRUE)
# comment <-
...
table(comment$title)
which(comment$title == "Red와 Black 집단의 서로 다른 결과를 보면")
N_labs <- 20
N_students <- 1060
...
## 게시 후 2주 이내 1점, 지나면 0.7점 부여 (11월 30일 23:59 기준)
