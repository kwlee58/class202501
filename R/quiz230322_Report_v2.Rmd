...
quiz <- 
  read_excel("../data/quiz230322.xlsx",
             range = "A2:N918",
             col_names = FALSE)
...
quiz$days <- as.numeric(difftime("2023-04-05 09:00:00", quiz$time, units = 'days'))
quiz$hours <- as.numeric(difftime("2023-04-05 09:00:00", quiz$time, units = 'hours'))
str(quiz)
```
...
ggsave("../pics/Quiz230322_Q7_RnB.png", dpi = 120, width = 960, height = 840, units = "px")
```
...
title(main = paste0("Quiz230322 (", N, "명 제출)"))
# title(main = "일 단위 퀴즈 제출 인원", sub = paste0("Quiz230322 (", N, "명 제출)"))
dev.copy(png, file = "../pics/2301/quiz_submission_4.png", width = 640, height = 480)
invisible(dev.off())
```

```{r, save, echo = FALSE}
saveRDS(quiz, file = "./quiz230322.RDS")
save.image("../R/quiz230322.RData")
```