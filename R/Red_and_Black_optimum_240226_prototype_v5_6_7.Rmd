...
# "./red_and_black_optimum_data_202301_v5_100.RData"
...
```{r, echo = FALSE}
hist(Xsum, prob = TRUE, nclass = 50, xlim = c(0, 70), ylim = c(0, 0.06))
x <- seq(0, 70, by = 0.1)
...
<!--
```{r, save}
save.image("./red_and_black_optimum_data_240226_v5_6_7.RData")
```
-->