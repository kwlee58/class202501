---
title: "Quiz 250519 (Framing Effects)"
author: "coop711"
date : "2025-05-19"
...
quiz_url <-"https://docs.google.com/spreadsheets/d/1BB9vDy4labNDKgxuf18jfoJWlLda5RTmb2cl7donRIg"
# gs4_deauth()
quiz <- read_sheet(quiz_url)
# quiz <- 
#   read_excel("./data/quiz250519.xlsx",
#              range = "A1:Y701")
names(quiz) <- 
...
title(main = paste0("Quiz250519 (", N, "명 제출)"))
# title(main = "일 단위 퀴즈 제출 인원", sub = paste0("Quiz230925 (", N, "명 제출)"))
dev.copy(png, file = "./pics/2501/quiz_submission_12.png", width = 640, height = 480)
invisible(dev.off())
})
```
...
ggsave("./pics/Quiz250519_submission_12.png", dpi = 120, width = 960, height = 840, units = "px")
```

```{r, save, echo = FALSE}
saveRDS(quiz, file = "quiz250519.RDS")
```
