...
그 결과 카이제곱 통계량은 `r format(oxford_chisq_test[1], digits = 2, nsmall = 2)`,  자유도는 `r format(oxford_chisq_test[2], digits = 2, nsmall = 2)`, p-value 는 `r format(oxford_chisq_test[3], digits = 2, nsmall = 4)`이므로 통계적으로 유의한 차이를 보이고 있습니다.
