...
class_roll <- readRDS("./class_roll_241206.RDS")
total <-
  read_excel(path = "./data/Final_Records_2402_1224.xlsx",
             range = "A1:L798",
...
write.csv(army_records, file = "./data/army_records_2402.csv", 
          row.names = FALSE,
          fileEncoding = "UTF-8")
army_records
total2402 <- total
saveRDS(total2402, file = "total2402.RDS")
save.image(file = "final_Records2402.RData")
```
-->
