...
library(magrittr)
options(width = 180)
class_roll <- readRDS("./class_roll_240419.RDS")
oxford <- "./data/oxford_240419.xlsx" %>%
  read_excel(range = "A2:BM753",
             col_names = FALSE)
...
#> 마감기한으로부터 제출시점의 기간
oxford$days <- as.numeric(difftime("2024-05-03 09:00:00", oxford$Time1, tz = "Asia/Seoul", units = 'days'))
oxford$hours <- as.numeric(difftime("2024-05-03 09:00:00", oxford$Time1, tz = "Asia/Seoul", units = 'hours'))
```
...
```{r, save, echo = FALSE}
saveRDS(oxford, file = "./oxford240419.RDS")
save.image("./oxford240419.RData")
```
