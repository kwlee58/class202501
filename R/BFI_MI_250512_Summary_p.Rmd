...
성실성의 경우 "높음"은 `r BFI_tbl[1, 3]`명, "낮음"은 `r BFI_tbl[4, 3]`명으로 "낮음"이 좀 많습니다. 성실성이 "중하"이하인 사람은 `r BFI_tbl[3, 3] + BFI_tbl[4, 3]`명으로 성실성이 "중상"이상인 사람, `r BFI_tbl[1, 3] + BFI_tbl[2, 3]`명 보다 적습니다. 성실성의 분포는 마감일이 다가옴에 따라 큰 변화를 보입니다. 특히 "낮음"이 얼마나 늘어나는지 관찰해 보세요. 
