---
title: "Quiz 230524 (Birthday Problem, Matching Problem, Monty Hall Show)"
author: "coop711"
date: "2023-05-24"
...
quiz <- "../data/quiz230524.xlsx" %>% 
  read_excel(range = "A1:N872",
...
quiz$days <- as.numeric(difftime("2023-06-07 09:00:00", quiz$time, units = 'days'))
quiz$hours <- as.numeric(difftime("2023-06-07 09:00:00", quiz$time, units = 'hours'))
str(quiz)
```
...
ggsave("../pics/Quiz230524_Q4_RnB.png", dpi = 120, width = 960, height = 840, units = "px")
```

## 일 단위 마감 시간으로부터 제출 시간의 분포

```{r, echo = FALSE}
# png(file = "../pics/2301/quiz_submission_13.png", width = 640, height = 480)
...
# title(main = paste0("Quiz230524 (", N, "명 제출)"))
title(main = "일 단위 퀴즈 제출 인원", sub = paste0("Quiz230524 (", N, "명 제출)"))
# dev.copy(png, file = "../pics/2301/quiz_submission_13.png", width = 640, height = 480)
# invisible(dev.off())
```
...
library(magick)
file_names <- paste0("../pics/2301/quiz_submission_", 1:13, ".png")
...
```{r, save, echo = FALSE}
saveRDS(quiz, file = "./quiz230524.RDS")
save.image("../R/quiz230524.RData")
```