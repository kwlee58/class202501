...
따라서 부연설명이 영향을 끼치지 않는다는 가정은 티당치 않은 것으로 볼 수밖에 없게 되었습니다.
...
찬성을 유도하는 부연설명을 붙이느냐, 반대를 유도하는 부연설명을 붙이느냐에 따라 반응이 진다는 것을 알 수 있지만 그 차이가 통계적으로 유의한 수준은 아닌 것입니다. 

Red 와 Black 간의 차이가 통계적으로 유의하지 않으니까 전체적으로 어느 정도가 "찬성한다"하고 어느 정도가 "반대한다"고 응답하였는지 합쳐 보겠습니다.
