...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red(랜덤화출석부)} & 219 & 10 \\
\textbf{Black(랜덤화출석부)} & 11 & 212 \\
\textbf{계} & 230 & 222 \\
\end{longtable}
...
Red를 Black 이라고 한 사람이 10명, Black 을 Red 라고 한 사람이
11명입니다.

두 가지 방법으로 분석합니다.

우선 Red, Black 을 잘못 선택한 21명을 랜덤하게 둘로 나누면 어느 한 쪽
집단에 들어갈 기대인원은 21명을 둘로 나눈 10.5(명)이고, 표준오차는 21의
제곱근에 1/2을 곱해 준 2.3명이 됩니다.

실제로 Red를 Black 이라고 한 사람수, 10명이나 Black 을 Red 라고 한
사람수, 11명은 기대인원으로부터 표준오차 범위 안에 아주 잘 들어갑니다.

두 번째 분석 방법은 확률을 계산해 보는 것입니다.

Red, Black 을 잘못 선택한 21명을 랜덤하게 둘로 나눌 때, 실제로 관찰된
11명 이상이나 10명이하로 잘못 선택한 사람수가 나올 가능성은 얼마나
되는가 입니다.

이 경우 공평한 동전던지기를 확률 법칙으로 표현한 이항분포로부터 계산할
수 있습니다.

시행횟수가 21이고 한 번 시행에서 성공확률이 1/2 인 이항분포에서
성공횟수가 10이하이거나 11이상을 관찰할 확률은 1입니다.

공평한 동전 던지기에서 앞면이 10개 이하 나오는 확률은 11개 이상 나오는
...
Red 로 응답한 인원은 230명, Black 에 응답한 인원은 222명입니다.

전체 응답인원 452 명을 랜덤하게 둘로 나눌 때 어느 한 쪽의 기대인원은
전체 응답인원의 절반인 226명이고, 표준오차는 전체 응답인원의 제곱근에
1/2을 곱해 준 10.6 명입니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red} & 35 & 5 & 183 & 7 & 0 & 230 \\
\textbf{Black} & 19 & 13 & 176 & 10 & 4 & 222 \\
\textbf{계} & 54 & 18 & 359 & 17 & 4 & 452 \\
\end{longtable}
...
그 결과 카이제곱 통계량은 12.82, 자유도는 NA , p-value 는 0.0080이므로
...
\bottomrule\noalign{}
\endlastfoot
11.95 & 3.98 & 79.42 & 3.76 & 0.88 & 100.00 \\
\end{longtable}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red} & 0 & 1 & 8 & 72 & 149 & 230 \\
\textbf{Black} & 2 & 2 & 7 & 73 & 138 & 222 \\
\textbf{계} & 2 & 3 & 15 & 145 & 287 & 452 \\
\end{longtable}
...
그 결과 카이제곱 통계량은 2.316, 자유도는 NA, p-value 는 0.5932이므로
Red, Black 간에 통계적으로 유의한 차이를 보이지 않습니다.
...
\bottomrule\noalign{}
\endlastfoot
0.44 & 0.66 & 3.32 & 32.08 & 63.50 & 100.00 \\
\end{longtable}

정답률은 Red, Black 을 합하여 계산하는데, 63.5(\%) 입니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red} & 25 & 183 & 18 & 4 & 230 \\
\textbf{Black} & 22 & 174 & 21 & 5 & 222 \\
\textbf{계} & 47 & 357 & 39 & 9 & 452 \\
\end{longtable}
...
그 결과 카이제곱 통계량은 0.619, 자유도는 3, p-value 는 0.8921이므로
Red, Black 간에 통계적으로 유의한 차이를 보이지 않습니다.
...
\bottomrule\noalign{}
\endlastfoot
10.4 & 79.0 & 8.6 & 2.0 & 100.0 \\
\end{longtable}

정답률은 Red, Black 을 합하여 계산하는데, 79.0(\%) 입니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red} & 40 & 22 & 167 & 1 & 230 \\
\textbf{Black} & 20 & 23 & 171 & 8 & 222 \\
\textbf{계} & 60 & 45 & 338 & 9 & 452 \\
\end{longtable}
...
그 결과 카이제곱 통계량은 12.043, 자유도는 NA, p-value 는 0.0060이므로
Red, Black 간에 통계적으로 유의한 차이를 보이지 않습니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red} & 12 & 11 & 194 & 13 & 230 \\
\textbf{Black} & 8 & 12 & 192 & 10 & 222 \\
\textbf{계} & 20 & 23 & 386 & 23 & 452 \\
\end{longtable}
...
그 결과 카이제곱 통계량은 1.104, 자유도는 NA, p-value 는 0.7621이므로
Red, Black 간에 통계적으로 유의한 차이를 보이지 않습니다.
...
\bottomrule\noalign{}
\endlastfoot
4.4 & 5.1 & 85.4 & 5.1 & 100.0 \\
\end{longtable}

정답률은 Red, Black 을 합하여 계산하는데, 85.4(\%) 입니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red} & 141 & 29 & 38 & 22 & 230 \\
\textbf{Black} & 109 & 47 & 35 & 31 & 222 \\
\textbf{계} & 250 & 76 & 73 & 53 & 452 \\
\end{longtable}
...
그 결과 카이제곱 통계량은 9.872, 자유도는 3, p-value 는 0.0197이므로
Red, Black 간에 통계적으로 유의한 차이를 보이지 않습니다.
...
\bottomrule\noalign{}
\endlastfoot
55.3 & 16.8 & 16.2 & 11.7 & 100.0 \\
\end{longtable}

정답률은 Red, Black 을 합하여 계산하는데, 55.3(\%) 입니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red(김영란법 국회통과)} & 51 & 150 & 29 & 230 \\
\textbf{Black(고위공직자 범죄수사처 설립)} & 81 & 92 & 49 & 222 \\
\textbf{계} & 132 & 242 & 78 & 452 \\
\end{longtable}
...
230명이 응답한 가운데 51명이 결과를 ``제대로 보여주고 있다''는 반응을
보이고, 150명이 결과를 ``제대로 보여주고 있지 않다''는 반응을 보입니다.

Black은 2017년 대선의 대선주자 여론조사에서 33\%의 지지율을 기록한
문재인 예비후보와 22\%의 지지율을 기록한 안희정 예비후보의 지지율 막대가
거의 비슷한 것처럼 왜곡하였습니다.

222명이 응답한 가운데 81명이 여론조사 결과를 '' 제대로 보여주고 있다''는
반응을 보이고, 92명이 여론조사 결과를 ``제대로 보여주고 있지 않다''는
반응을 보입니다.

그리고 ``모름/무응답''에 답한 인원은 Red에 29명, Black 에 49명이
었습니다.
...
카이제곱 통계량은 25.714, 자유도는 2, p-value 는 2.6e-06(으)로 그래프의
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red(김영란법 국회통과)} & 22.2 & 65.2 & 12.6 & 100.0 \\
\textbf{Black(고위공직자 범죄수사처 설립)} & 36.5 & 41.4 & 22.1 &
100.0 \\
\end{longtable}

원형그래프의 각도를 왜곡한 Red에서 여론조사 결과를 ``제대로 보여주고
있다''고 응답하는 사람들의 백분율, 22.2(\%)은 ``제대로 보여주고 있지
않다''고 응답하는 사람들의 백분율, 65.2(\%) 보다 매우 낮습니다.

반면 막대그래프의 높이를 왜곡한 Black에서 여론조사 결과를 ``제대로
보여주고 있다''고 응답하는 사람들의 백분율, 36.5(\%)은 ``제대로 보여주고
있지 않다''고 응답하는 사람들의 백분율, 41.4(\%) 보다 적습니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red} & 0 & 17 & 9 & 6 & 12 & 8 & 12 & 51 & 20 & 13 & 21 & 13 &
21 & 27 & 230 \\
\textbf{Black} & 0 & 10 & 11 & 3 & 6 & 7 & 9 & 43 & 19 & 18 & 20 & 22 &
26 & 28 & 222 \\
\textbf{계} & 0 & 27 & 20 & 9 & 18 & 15 & 21 & 94 & 39 & 31 & 41 & 35 &
47 & 55 & 452 \\
\end{longtable}
...
\bottomrule\noalign{}
\endlastfoot
27 & 20 & 9 & 18 & 15 & 21 & 94 & 39 & 31 & 41 & 35 & 47 & 55 \\
\end{longtable}
...
카이제곱 통계량은 170.91, 자유도는 12.00, p-value 는 3.1e-30 이므로 결코
...
막대그래프는 총 제출인원 452(명) 중에 0(명), 0(\%)가 마감일에 몰리는
것을 명확히 보여주고 있습니다.
...
27 \\
\textbf{Black} & 10 & 11 & 3 & 6 & 7 & 9 & 43 & 19 & 18 & 20 & 22 & 26 &
28 \\
\end{longtable}
...
이번에는 분포표의 첫번쨰와 두번쨰 행, '계'열을 제외한 나머지 열에 대해서
카이제곱테스트를 수행합니다.

카이제곱 통계량은 9.773, 자유도는 12, p-value 는 0.6358 이므로 제출
