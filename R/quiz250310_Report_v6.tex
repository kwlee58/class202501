...
2025-03-23 20:12:51 & 20241713 & Black & Red \\
\end{longtable}
...
우선 Red, Black 을 잘못 선택한 25명을 랜덤하게 둘로 나누면 어느 한 쪽
집단에 들어갈 기대인원은 25명을 둘로 나눈 12.5(명)이고, 표준오차는 25의
제곱근에 1/2을 곱해 준 2.5명이 됩니다.

실제로 Red를 Black 이라고 한 사람수, 12명이나 Black 을 Red 라고 한
사람수, 13명은 기대인원으로부터 표준오차 범위 안에 아주 잘 들어갑니다.

두 번째 분석 방법은 확률을 계산해 보는 것입니다.

Red, Black 을 잘못 선택한 25명을 랜덤하게 둘로 나눌 때, 실제로 관찰된
13명 이상이나 12명이하로 잘못 선택한 사람수가 나올 가능성은 얼마나
되는가 입니다.

이 경우 공평한 동전던지기를 확률 법칙으로 표현한 이항분포로부터 계산할
수 있습니다.

시행횟수가 25이고 한 번 시행에서 성공확률이 1/2 인 이항분포에서
성공횟수가 12이하이거나 13이상을 관찰할 확률은 1입니다.

공평한 동전 던지기에서 앞면이 12개 이하 나오는 확률은 13개 이상 나오는
...
Red 로 응답한 인원은 281명, Black 에 응답한 인원은 281명입니다.

전체 응답인원 562 명을 랜덤하게 둘로 나눌 때 어느 한 쪽의 기대인원은
전체 응답인원의 절반인 281명이고, 표준오차는 전체 응답인원의 제곱근에
1/2을 곱해 준 11.9 명입니다.
...
그 결과 카이제곱 통계량은 9.06, 자유도는 NA , p-value 는 0.0585이므로
...
그 결과 카이제곱 통계량은 2.056, 자유도는 NA, p-value 는 0.6747이므로
Red, Black 간에 통계적으로 유의한 차이를 보이지 않습니다.
...
그 결과 카이제곱 통계량은 8.269, 자유도는 NA, p-value 는 0.0315이므로
...
그 결과 카이제곱 통계량은 0.795, 자유도는 NA, p-value 는 0.8676이므로
Red, Black 간에 통계적으로 유의한 차이를 보이지 않습니다.
...
\pandocbounded{\includegraphics[keepaspectratio]{quiz250310_Report_v6_files/figure-latex/mosaic plot-1.pdf}}
...
카이제곱 통계량은 281.60, 자유도는 13.00, p-value 는 1.7e-52 이므로 결코
...
\pandocbounded{\includegraphics[keepaspectratio]{quiz250310_Report_v6_files/figure-latex/unnamed-chunk-15-1.pdf}}
...
카이제곱 통계량은 9.390, 자유도는 13, p-value 는 0.7429 이므로 제출
...
\pandocbounded{\includegraphics[keepaspectratio]{quiz250310_Report_v6_files/figure-latex/unnamed-chunk-17-1.pdf}}
