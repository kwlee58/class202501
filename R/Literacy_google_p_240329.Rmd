...
class_roll <- readRDS("./class_roll_240329.RDS")
literacy_roll <- 
  read_excel("./data/literacy_240329.xlsx",
             range = "C1:AD775",
             col_names = TRUE)
...
absentee$group %>%
  table
#> RDS 포맷으로 저장 
saveRDS(literacy_roll, file = "./literacy_roll240329.RDS")
```
...
# png(file = "./pics/Literacy_240329.png", width = 640, height = 840)
...
# dev.copy(png, file = "./pics/Literacy_240329.png", width = 640, height = 840)
invisible(dev.off())
```
...
#  coord_flip()
ggsave(file = "./pics/Literacy_240329_ggplot.png", bg = "white", dpi = 72, width = 840, height = 480, units = "px")
```
