---
title: "Quiz 240412 (Wason Selection Task)"
author: "coop711"
date: "2024-04-12"
...
class_roll <- readRDS("./class_roll_240426.RDS")
# class_roll <- 
...
quiz_url <-
  "https://docs.google.com/spreadsheets/d/17ztPuUxD179Pfv1P97d-VLpQv5m6HP2RHvq-WFJbqFI"
# gs4_deauth()
...
#> 마감기한으로부터 제출시점의 기간
quiz$days <- as.numeric(difftime("2024-04-26 00:00:00", quiz$time, units = 'days'))
quiz$hours <- as.numeric(difftime("2024-04-26 00:00:00", quiz$time, units = 'hours'))
str(quiz)
```
...
m + geom_text(aes(x = center, y = 1.05), 
  ...
  theme(plot.title = element_text(hjust = 0.5, 
                                  size = 18, 
                                  face = "bold")) 
ggsave("./pics/Quiz240412_Q7_RnB.png", dpi = 120, width = 960, height = 840, units = "px")
```
...
m + geom_text(aes(x = center, y = 1.05), 
  ...
  theme(plot.title = element_text(hjust = 0.5, 
                                  size = 18, 
                                  face = "bold")) 
ggsave("./pics/Quiz240412_Q8_RnB.png", dpi = 120, width = 960, height = 840, units = "px")
```
...
m + geom_text(aes(x = center, y = 1.05), 
  ...
  theme(plot.title = element_text(hjust = 0.5, 
                                  size = 18, 
                                  face = "bold")) 
ggsave("./pics/Quiz240412_Q9_RnB.png", dpi = 120, width = 960, height = 840, units = "px")
```

Mosaic Plot으로부터 확증편향에서 비롯된 응답의 비율이 정답의 비율이나 기타 응답의 비율보다 월등히 높다는 것을 시각적으로 파악할 수 있습니다. 다.
...
m + 
  ...
  theme(plot.title = element_text(hjust = 0.5, 
                                  size = 18, 
                                  face = "bold")) 
ggsave("./pics/Quiz240412_Wason_RnB.png", dpi = 120, width = 960, height = 840, units = "px")
```
...
b_fill + 
  ...
  theme(plot.title = element_text(hjust = 0.5, 
                                  size = 18, 
                                  face = "bold")) 
ggsave("./pics/Quiz240412_Wason_Result.png", dpi = 120, width = 960, height = 840, units = "px")
```
...
title(main = paste0("Quiz240412 (", N, "명 제출)"))
...
ggsave("./pics/Quiz240412_submission_7.png", dpi = 120, width = 960, height = 840, units = "px")
```

```{r, save, echo = FALSE}
saveRDS(quiz, file = "quiz240412.RDS")
```
