---
title: "Quiz 251103 (Prospect Theory)"
author: "coop711"
date : "2025-05-05"
...
quiz_url <-"https://docs.google.com/spreadsheets/d/1vgjuOZQ0SKF8OF-zwTDeHDmi-FuSF_TmQMQFPHMGtS0"
# gs4_deauth()
...
quiz <- data.frame(quiz)
#> 마감기한으로부터 제출시점의 기간
quiz$days <- as.numeric(difftime("2025-11-17 00:00:00", quiz$time, tz = "Asia/Seoul",  units = 'days'))
quiz$hours <- as.numeric(difftime("2025-11-17 00:00:00", quiz$time, tz = "Asia/Seoul", units = 'hours'))
quiz %>% 
  str  
```
...
title(main = paste0("Quiz251103 (", N, "명 제출)"))
...
ggsave("./pics/Quiz251103_submission_10.png", dpi = 120, width = 960, height = 840, units = "px")
```

```{r, save, echo = FALSE}
saveRDS(quiz, file = "quiz251103.RDS")
```
